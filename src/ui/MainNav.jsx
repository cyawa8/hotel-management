  ...
  return (
    <nav>
      <NavList>
        ...
        <li> <StyledNavLink to="/users"> <HiOutlineUser /><span>User</span></StyledNavLink> </li>
        <li> <StyledNavLink to="/setting"> <HiOutlineCog6Tooth /><span>Setting</span></StyledNavLink> </li>
      </NavList>
    </nav>
  );
}
