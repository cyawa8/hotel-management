...
function CheckinBooking() {
  ...
  const optionalBreakfastPrice = setting.breakfast_price * num_night * num_quest;
    ...
    <>
      ...
      <Box>
        <Checkbox 
          ...
          id="confirm"
        >
          I confirm that {guest_id.first_name } has paid the total amount {" "}{!addBreakfast ? formatCurrency(total) : `${formatCurrency(total + optionalBreakfastPrice)} (${formatCurrency(total)} + ${formatCurrency(optionalBreakfastPrice)})`}
        </Checkbox>
      </Box>
